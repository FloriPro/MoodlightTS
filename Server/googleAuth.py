...
def google_auth_redirect():
    ...
    if flask.request.cookies.get('redirectAfterLogin') != None:
        response = flask.make_response(
            '<meta http-equiv="Refresh" content="0; url='+flask.request.cookies.get('redirectAfterLogin')+'" />')
...
def logout():
    ...
    if flask.request.args.get("redirect") != None:
        return flask.redirect(flask.request.args.get("redirect"), code=302)
